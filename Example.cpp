...
int main()
{
	...
	ConsoleTable::TableChars chars{'+', '+', '+', '+',
								   '-', '+', '+',
								   '|', '+', '+',
								   '+'}; // creating TableChars struct with standard symbols setup
	...
	ConsoleTable::TableChars chars2; // creating TableChars struct with standard symbols setup
	chars.centreSeparation = '+'; // changing symbol in struct
	table.setTableChars(chars2); // set TableChars struct as new symbol setup
